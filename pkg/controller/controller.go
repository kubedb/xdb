...
func New(cfg *rest.Config) *Controller {
	...
	return &Controller{
		...
		eventRecorder:  eventer.NewEventRecorder(c.Client, "Xdb Controller"),
...
func (c *Controller) watchXdb() {
	lw := &cache.ListWatch{
		ListFunc: func(opts kapi.ListOptions) (runtime.Object, error) {
			return c.ExtClient.Xdbes(kapi.NamespaceAll).List(kapi.ListOptions{})
		},
		WatchFunc: func(options kapi.ListOptions) (watch.Interface, error) {
			return c.ExtClient.Xdbes(kapi.NamespaceAll).Watch(kapi.ListOptions{})
		},
	}
...
func (c *Controller) watchDatabaseSnapshot() {
	labelMap := map[string]string{
		amc.LabelDatabaseType: tapi.ResourceNameXdb,
	}
...
func (c *Controller) ensureThirdPartyResource() {
	...
	resourceName := tapi.ResourceNameXdb + "." + tapi.V1beta1SchemeGroupVersion.Group
